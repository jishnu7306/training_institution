...
from softwareapp import views
from trainingapp import views as training_views
...
urlpatterns = [
 ...
 #**********************Training project ******************
    ...
    path('attenperform/<int:id>',training_views.attenperform, name='attenperform'),
    path('trainer_currenttraineesdetails/<int:id>', training_views.trainer_currenttraineesdetails, name='trainer_currenttraineesdetails'),
    path('trainer_currentattentable/<int:id>', training_views.trainer_currentattentable, name='trainer_currentattentable'),
    path('trainer_currentperform/<int:id>', training_views.trainer_currentperform, name='trainer_currentperform'),
    path('trainer_currentattenadd/<int:id>', training_views.trainer_currentattenadd, name='trainer_currentattenadd'),
    path('trainer_previousteam/', training_views.trainer_previousteam, name='trainer_previousteam'),
    path('trainer_previoustrainees/<int:id>', training_views.trainer_previoustrainees, name='trainer_previoustrainees'),
    path('trainer_previoustraineesdetails/<int:id>', training_views.trainer_previoustraineesdetails, name='trainer_previoustraineesdetails'),
    path('trainer_previousattentable/<int:id>', training_views.trainer_previousattentable, name='trainer_previousattentable'),
    path('trainer_previousperfomtable/<int:id>', training_views.trainer_previousperfomtable, name='trainer_previousperfomtable'),
...
# ****************************Admin******************************
   ...
   path('Admin_categories/', training_views.Admin_categories, name='Admin_categories'),
   path('Admin_emp_categories/', training_views.Admin_emp_categories, name='Admin_emp_categories'),
   path('Admin_courses/<int:id>/', training_views.Admin_courses, name='Admin_courses'),
   ...
   path('Admin_previous_task/', training_views.Admin_previous_task,name='Admin_previous_task'),
   path('Admin_registration_details/', training_views.Admin_registration_details,name='Admin_registration_details'), 
   path('Admin_attendance/', training_views.Admin_attendance, name='Admin_attendance'),
   path('Admin_attendance_show/', training_views.Admin_attendance_show,name='Admin_attendance_show'),
   path('Admin_reported_issues/', training_views.Admin_reported_issues,name='Admin_reported_issues'),
   path('Admin_emp_reported_detail/', training_views.Admin_emp_reported_detail,name='Admin_emp_reported_detail'),
   path('Admin_emp_reported_issue_show/', training_views.Admin_emp_reported_issue_show,name='Admin_emp_reported_issue_show'),
   path('Admin_manager_reported_detail/',training_views.Admin_manager_reported_detail,name='Admin_manager_reported_detail'),
   path('Admin_manager_reported_issue_show/',training_views.Admin_manager_reported_issue_show,name='Admin_manager_reported_issue_show'),

   path('Admin_add/', training_views.Admin_add, name='Admin_add'),
   path('Admin_addcategories/', training_views.Admin_addcategories, name='Admin_addcategories'),
   path('Admin_addcourse/', training_views.Admin_addcourse, name='Admin_addcourse'),
   path('Admin_addnewcategories/', training_views.Admin_addnewcategories, name='Admin_addnewcategories'),
   path('Admin_addnewcourse/', training_views.Admin_addnewcourse, name='Admin_addnewcourse'),
   path('Admin_categorieslist/', training_views.Admin_categorieslist, name='Admin_categorieslist'),
   ...
   path('Admin_employee', training_views.Admin_employee, name='Admin_employee'),
    ...
    path('accounts_paydetails/<int:id>/<int:tid>/', training_views.accounts_paydetails, name='accounts_paydetails'),
